...
// Replace the methods
const isValidGroupRegex = /isValidGroup\(tiles\)[\s\S]+?return true;\s+}/;
const isValidSetRegex = /isValidSet\(tiles\)[\s\S]+?return isGroup;\s+}/;

content = content.replace(isValidGroupRegex, updatedIsValidGroup);
content = content.replace(isValidSetRegex, updatedIsValidSet);
