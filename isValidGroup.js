  /**
 * Validates whether a set of tiles forms a valid group (same number, different colors)
 * @param {Array} tiles - Array of tile objects to validate
 * @returns {boolean} - Whether the tiles form a valid group
 */
